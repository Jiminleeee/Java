...
public class Busan {
	...
	public static void main(String[] args) throws IOException {
		...
		for (int t = 0; t < 100; t++) {
			...
			driver.get(
					"https://search.naver.com/search.naver?where=view&query=%EB%B6%80%EC%82%B0%20%EB%B9%B5%EC%A7%91&sm=tab_opt&nso=so%3Ar%2Cp%3A"
			...
			FileWriter fw = new FileWriter("C:\\Users\\501-21\\Desktop\\kopo32\\프로젝트\\빵집\\부산.csv", true);
